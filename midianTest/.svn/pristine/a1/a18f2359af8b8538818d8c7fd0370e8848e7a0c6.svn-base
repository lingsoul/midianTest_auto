...
public class Register {
	...
	public void addCookies(String URL, String username, String password, String answer) {
	...
	/*
	 * @Test(dataProvider = "getUrlInfoArrayObject", threadPoolSize = 3,
	 * invocationCount = 6, timeOut = 3000) public void addCookies2(UrlInfo
	 * urlInfo) { WebDriver driver = LocalWebDriverFactory.getFireFoxDriver();
	 * RegisterPage registerPage = new RegisterPage(driver);
	 * driver.manage().window().maximize(); driver.get(urlInfo.getUrl());
	 * driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS); //
