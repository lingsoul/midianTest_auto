...
public class ExcelData {
	...
	private static String fileName = "DataProvider.xls";
	private static int beginColumnNum = 3;
	private static int endColumnNum = 3;
	private static int endRowNum;
	/*private static int beginColNum = 3;
	private static int endColNum = 3;*/

    public static Object[][] getData(String sheetName,int beginRowNum) {
    	endRowNum = beginRowNum;
        // 判断传入的值是否合法 待续....
        Object[][] array = null;
        // 文件路径
        try {
