...
public class FixedPricePublishEle {
	...
	/* 第一个域名勾选框 */
	@FindBy(how = How.XPATH, xpath = "/html/body/div[1]/div[3]/div[2]/div/form/div/div[2]/table/tbody/tr[1]/td[1]/label/i")
	...
	/* 发布一口价按钮 */
	@FindBy(how = How.XPATH, xpath = "/html/body/div[1]/div[3]/div[2]/div/div/div/a[1]")
	public WebElement FixedPricebtn;
	...
	/* 安全问题答案输入框 */
	@FindBy(how = How.XPATH, xpath = "/html/body/div[1]/div[4]/form/div[2]/li[2]/div/input")
	public WebElement answertxt;

	/* 安全问题确认按钮 */
	@FindBy(how = How.XPATH, xpath = "/html/body/div[1]/div[4]/form/div[2]/li[3]/div/input")
	...
	public FixedPricePublishEle(WebDriver driver) {
		this.driver = driver;
