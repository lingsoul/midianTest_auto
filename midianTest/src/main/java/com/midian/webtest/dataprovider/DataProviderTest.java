...
public class DataProviderTest {
    ...
    public static Object[][] getUrlInfoArray() {
        ...
        return ExcelDataProvider
        		.getData(filePath, "DataProvider.xls", "testA",beginRowNum, endRowNum,beginColNum,endColNum);
    }
    ...
    public static Object[][] getUrlInfoArrayTradeReg() {
        ...
        int endColNum = 2;
        return ExcelDataProvider
        		.getData(filePath, "DataProvider.xls", "TradeReg",beginRowNum, endRowNum,beginColNum,endColNum);
    }
    ...
    public static Iterator<Object[]> getUrlInfoArrayObject() {
        ...
        int beginColNum = 1;
        int endColNum = 3;
        Object[][] array = ExcelDataProvider
        		.getData(filePath, "DataProvider.xls", "testC",beginRowNum, endRowNum,beginColNum, endColNum);
        Iterator<Object[]> iterator = BeanUtils.arrayToIterator(array, UrlInfo.class);
        return iterator;
    }

/*    @Test(dataProvider = "getUrlInfoArray", dataProviderClass = DataProviderConf.class)
